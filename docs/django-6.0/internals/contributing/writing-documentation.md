...
<a id="documentation-code-block-format-check"></a>
...
auto-formatter. This is automatically run by the [pre-commit hook](writing-code/coding-style.md#coding-style-pre-commit) if configured.
...
<a id="documentation-lint-check"></a>
...
Sphinx can generate a manual page for the [django-admin](../../ref/django-admin.md) command. This is configured in `docs/conf.py`. Unlike

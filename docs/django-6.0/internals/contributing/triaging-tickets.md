...
[required details](bugs-and-features.md#reporting-bugs). A number of tickets have proposed
solutions, but those don’t necessarily meet all the requirements [adhering
to the guidelines for contributing](writing-code/submitting-patches.md#patch-style).
...
any role except merger. The [merger role](../organization.md#mergers-team) is granted by a
vote of the [Steering Council](../organization.md#steering-council).
...
[triage and collaboration by the community](#how-can-i-help-with-triaging). This could be you!
...
* Jacob, a [merger](../organization.md#mergers-team), reviews and merges the pull request.
...
* **Needs Patch** (Accepted + No Flags)
  ...
  through the appropriate [process for suggesting new features](bugs-and-features.md#requesting-features) and received community and [Steering Council](../organization.md#steering-council) approval, or been accepted in a DEP.
...
ensure they adhere to the [documented guidelines](writing-code/submitting-patches.md#patch-review-checklist).
...
bring the issue to the [Django Forum](https://forum.djangoproject.com/) instead.

...
you don’t fix the bug itself. See more at [How can I help with development?](triaging-tickets.md#how-can-i-help-with-triaging).
...
still supported versions of Python. [Run the tests](writing-code/unit-tests.md) and make sure they pass.
...
[Contribution checklist](writing-code/submitting-patches.md#patch-review-checklist).
...
is more than one or two lines of code, you need to sign the [CLA](https://www.djangoproject.com/foundation/cla/). See the
[Contributor License Agreement FAQ](https://www.djangoproject.com/foundation/cla/faq/) for a more thorough explanation.

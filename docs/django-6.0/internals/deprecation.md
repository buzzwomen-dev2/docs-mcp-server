...
<a id="deprecation-removed-in-7-0"></a>

## 7.0

See the [Django 6.0 release notes](../releases/6.0.md#deprecated-features-6-0) for more
...
* The [`django.core.mail`](../topics/email.md#module-django.core.mail) APIs will no longer accept certain parameters as
...
See the [Django 6.1 release notes](../releases/6.1.md#deprecated-features-6-1) for more
details on these changes.

* Calling [`QuerySet.values_list()`](../ref/models/querysets.md#django.db.models.query.QuerySet.values_list) with `flat=True` and no field name
...
* The class `django.core.management.NoArgsCommand` will be removed. Use
  [`BaseCommand`](../howto/custom-management-commands.md#django.core.management.BaseCommand) instead, which takes no
...
* The default value of the [`RedirectView.permanent`](../ref/class-based-views/base.md#django.views.generic.base.RedirectView.permanent) attribute will change
  from `True` to `False`.
...
* Translations located under the so-called *project path* will be ignored
  ...
  [`LOCALE_PATHS`](../ref/settings.md#std-setting-LOCALE_PATHS) setting can be used for the same task by including

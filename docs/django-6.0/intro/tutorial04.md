...
This tutorial begins where [Tutorial 3](tutorial03.md) left off.
...
[`DetailView`](../ref/class-based-views/generic-display.md#django.views.generic.detail.DetailView) generic views abstract the

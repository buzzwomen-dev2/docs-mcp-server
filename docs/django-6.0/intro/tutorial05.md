...
Here we have created a [`django.test.TestCase`](../topics/testing/tools.md#django.test.TestCase) subclass with a method
...
based on our [`shell`](../ref/django-admin.md#django-admin-shell) session above.

...
This tutorial begins where [Tutorial 6](tutorial06.md) left off.
...
[`fieldsets`](../ref/contrib/admin/index.md#django.contrib.admin.ModelAdmin.fieldsets) is the title of the
...
the database. Django knows that a [`ForeignKey`](../ref/models/fields.md#django.db.models.ForeignKey) should
...
created in [Tutorial 2](tutorial02.md)), as follows:
...
#### SEE ALSO
The following [`ModelAdmin`](../ref/contrib/admin/index.md#django.contrib.admin.ModelAdmin) options allow
further customization of change lists:
[`list_per_page`](../ref/contrib/admin/index.md#django.contrib.admin.ModelAdmin.list_per_page),
[`search_fields`](../ref/contrib/admin/index.md#django.contrib.admin.ModelAdmin.search_fields),
[`date_hierarchy`](../ref/contrib/admin/index.md#django.contrib.admin.ModelAdmin.date_hierarchy), and
[`list_display`](../ref/contrib/admin/index.md#django.contrib.admin.ModelAdmin.list_display).
...
By default, it displays all the apps in [`INSTALLED_APPS`](../ref/settings.md#std-setting-INSTALLED_APPS) that have

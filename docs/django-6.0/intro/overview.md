...
[start with the tutorial](tutorial01.md) or [dive right into
more detailed documentation](../topics/index.md).
...
This example uses Django’s [template system](../topics/templates.md), which
...
check for templates with [`DIRS`](../ref/settings.md#std-setting-TEMPLATES-DIRS). If a template
...
[custom template filters](../howto/custom-template-tags.md#howto-writing-custom-template-filters). You can
write [custom template tags](../howto/custom-template-tags.md), which run

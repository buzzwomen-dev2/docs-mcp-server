...
You created `djangotutorial/templates` in [Tutorial 7](tutorial07.md), and `polls/templates` in
[Tutorial 3](tutorial03.md). Now perhaps it is clearer why we chose

...
[`Field`](../ref/models/fields.md#django.db.models.Field) to designate a human-readable name. That’s
...
schema automatically - that’s called [`migrate`](../ref/django-admin.md#django-admin-migrate), and we’ll come to it
...
Now, run [`migrate`](../ref/django-admin.md#django-admin-migrate) again to create those model tables in your
database:
...
By default, the [`shell`](../ref/django-admin.md#django-admin-shell) command automatically imports the models from
your [`INSTALLED_APPS`](../ref/settings.md#std-setting-INSTALLED_APPS).

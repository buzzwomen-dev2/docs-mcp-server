...
Windows Authentication or Apache and [mod_authnz_ldap](https://httpd.apache.org/docs/current/mod/mod_authnz_ldap.html), [CAS](https://www.apereo.org/projects/cas), [WebAuth](https://uit.stanford.edu/service/authentication),
[mod_auth_sspi](https://sourceforge.net/projects/mod-auth-sspi), etc.
...
This custom middleware is then used in the [`MIDDLEWARE`](../ref/settings.md#std-setting-MIDDLEWARE) setting
instead of [`django.contrib.auth.middleware.RemoteUserMiddleware`](../ref/middleware.md#django.contrib.auth.middleware.RemoteUserMiddleware):

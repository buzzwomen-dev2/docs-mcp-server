...
was caching pickled [`HttpResponse`](../ref/request-response.md#django.http.HttpResponse) objects, either directly
or indirectly via the [`cache_page()`](../topics/cache.md#django.views.decorators.cache.cache_page)
decorator.

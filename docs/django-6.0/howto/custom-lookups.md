...
to transform the values before comparison. We define [`bilateral = True`](../ref/models/lookups.md#django.db.models.Transform.bilateral) to indicate that this transformation

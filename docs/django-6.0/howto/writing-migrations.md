...
* In the first empty migration file, add a
  ...
  ```
* Now you can apply the migrations as usual with the [`migrate`](../ref/django-admin.md#django-admin-migrate)
  command.
...
Similarly, you’ll need to catch [`LookupError`](https://docs.python.org/3/library/exceptions.html#LookupError) in the `apps.get_model()`

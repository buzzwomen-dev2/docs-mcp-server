...
Alternatively, you can use the [Django template system](../topics/templates.md) to generate CSV. This is lower-level than using the
convenient Python [`csv`](https://docs.python.org/3/library/csv.html#module-csv) module, but the solution is presented here for
completeness.

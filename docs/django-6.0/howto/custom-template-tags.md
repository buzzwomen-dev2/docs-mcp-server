...
<a id="howto-custom-template-tags-simple-block-tags"></a>
...
Just like [simple_tag](#howto-custom-template-tags-simple-tags),
`simple_block_tag`:
...
according to a parameter given in the tag, in [`strftime()`](https://docs.python.org/3/library/time.html#time.strftime) syntax.

...
#### Versionchanged
[`BaseDatabaseSchemaEditor`](schema-editor.md#django.db.backends.base.schema.BaseDatabaseSchemaEditor) and
...
that you use [`SeparateDatabaseAndState`](#django.db.migrations.operations.SeparateDatabaseAndState) to add in operations that will

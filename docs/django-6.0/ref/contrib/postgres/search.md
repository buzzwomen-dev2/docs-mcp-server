...
[`GinIndex`](indexes.md#django.contrib.postgres.indexes.GinIndex) or
[`GistIndex`](indexes.md#django.contrib.postgres.indexes.GistIndex) which matches the search

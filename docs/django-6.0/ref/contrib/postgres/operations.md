...
[`allow_migrate()`](../../../topics/db/multi-db.md#allow_migrate) method of database routers to assist them in
[making routing decisions](../../../topics/db/multi-db.md#topics-db-multi-db-hints).

...
consult the [installation documentation](install/index.md) for more details.

This tutorial will guide you through the creation of a geographic web
application for viewing the [world borders](https://web.archive.org/web/20240123190237/https://thematicmapping.org/downloads/world_borders.php). <sup>[1](#id11)</sup> Some of the code
used in this tutorial is taken from and/or inspired by the [GeoDjango
basic apps](https://code.google.com/archive/p/geodjango-basic-apps) project. <sup>[2](#id12)</sup>
...
* [ogr2ogr](https://gdal.org/programs/ogr2ogr.html): A command-line utility included with GDAL that can import many
...
[LayerMapping data import utility](layermapping.md), it’s possible to further automate this
process with use of the [`ogrinspect`](commands.md#django-admin-ogrinspect) management command. The
[`ogrinspect`](commands.md#django-admin-ogrinspect) command  introspects a GDAL-supported vector data source
...
Now, define a point of interest <sup>[3](#id13)</sup>:
...
Consortium (OGC). <sup>[4](#id14)</sup>  Import the `WorldBorder` model, and perform
...
Similarly, you may also use a [GEOS geometry object](geos.md). Here, you can combine the `intersects` spatial
...
queries – the [GeoDjango Database API](db-api.md) documentation has more.
...
* <a id='id11'>**[1]**</a> Special thanks to Bjørn Sandvik of [mastermaps.net](https://mastermaps.net/) for providing and maintaining this dataset.
* <a id='id12'>**[2]**</a> GeoDjango basic apps was written by Dane Springmeyer, Josh Livni, and Christopher Schmidt.
* <a id='id13'>**[3]**</a> This point is the [University of Houston Law Center](https://www.law.uh.edu/).
* <a id='id14'>**[4]**</a> Open Geospatial Consortium, Inc., [OpenGIS Simple Feature Specification For SQL](https://www.ogc.org/standards/sfs).

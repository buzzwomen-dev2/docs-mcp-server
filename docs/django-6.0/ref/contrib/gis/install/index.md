...
3. [Geospatial libraries](geolibs.md#geolibs-list)
...
| MySQL      | GEOS, GDAL                   | 8.4+                 | [Limited functionality](../db-api.md#mysql-spatial-limitations). |
...
external shared libraries (e.g., for GEOS and GDAL) cannot be located. <sup>[1](#id22)</sup>
...
[Kurt Schwehr](https://schwehr.blogspot.com/) has been gracious enough to create GeoDjango packages for
users of the [Fink](https://www.finkproject.org/) package system. [Different packages are available](https://pdb.finkproject.org/pdb/browse.php?summary=django-gis)
...
* <a id='id22'>**[1]**</a> GeoDjango uses the [`find_library()`](https://docs.python.org/3/library/ctypes.html#ctypes.util.find_library) routine from `ctypes.util` to locate shared libraries.

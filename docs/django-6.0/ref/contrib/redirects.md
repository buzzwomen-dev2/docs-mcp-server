...
2. Add `'django.contrib.redirects'` to your [`INSTALLED_APPS`](../settings.md#std-setting-INSTALLED_APPS)
   setting.
...
[Django model](../../topics/db/models.md), which lives in
[django/contrib/redirects/models.py](https://github.com/django/django/blob/main/django/contrib/redirects/models.py). You can access redirect
objects via the [Django database API](../../topics/db/queries.md). For
example:

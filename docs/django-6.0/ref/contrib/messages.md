...
The [`MESSAGE_LEVEL`](../settings.md#std-setting-MESSAGE_LEVEL) setting can be used to change the minimum recorded
level (or it can be [changed per request]()). Attempts to add messages of a

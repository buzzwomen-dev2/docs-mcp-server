...
a longer length, please use a [custom user model](../../topics/auth/customizing.md#specifying-custom-user-model).
...
as unusable. See the [password documentation](../../topics/auth/passwords.md).
...
use [`AllowAllUsersModelBackend`](#django.contrib.auth.backends.AllowAllUsersModelBackend) or
[`AllowAllUsersRemoteUserBackend`](#django.contrib.auth.backends.AllowAllUsersRemoteUserBackend)
...
differentiating [`User`](#django.contrib.auth.models.User) and
[`AnonymousUser`](#django.contrib.auth.models.AnonymousUser) objects. Generally, you should prefer
using [`is_authenticated`](#django.contrib.auth.models.User.is_authenticated) to this
attribute.
...
documentation on [permissions](../../topics/auth/default.md#topic-authorization)). If the user
...
See [Creating users](../../topics/auth/default.md#topics-auth-creating-users) for example
usage.
...
[`ContentType`](contenttypes.md#django.contrib.contenttypes.models.ContentType) model.
...
: A dictionary of keyword arguments containing the user credentials that
  were passed to [`authenticate()`](../../topics/auth/default.md#django.contrib.auth.authenticate) or your own
...
[`has_perm()`](#django.contrib.auth.backends.ModelBackend.has_perm), [`get_all_permissions()`](#django.contrib.auth.backends.ModelBackend.get_all_permissions),
[`get_user_permissions()`](#django.contrib.auth.backends.ModelBackend.get_user_permissions), and [`get_group_permissions()`](#django.contrib.auth.backends.ModelBackend.get_group_permissions) allow an
...
behavior of [`AuthenticationForm.confirm_login_allowed()`](../../topics/auth/default.md#django.contrib.auth.forms.AuthenticationForm.confirm_login_allowed), this
...
because [`user_can_authenticate()`](#django.contrib.auth.backends.ModelBackend.user_can_authenticate) always returns
`True`.

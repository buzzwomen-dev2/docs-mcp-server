...
Assigns the [`HttpRequest`](../request-response.md#django.http.HttpRequest) to the view’s `request`
attribute, and any positional and/or keyword arguments
[captured from the URL pattern](../../topics/http/urls.md#how-django-processes-a-request)

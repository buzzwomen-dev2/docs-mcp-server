...
[`order_by()`](../models/querysets.md#django.db.models.query.QuerySet.order_by).
...
[`django.core.paginator.Paginator`](../paginator.md#django.core.paginator.Paginator) is used. If the custom
paginator class doesn’t have the same constructor interface as
[`django.core.paginator.Paginator`](../paginator.md#django.core.paginator.Paginator), you will also need to provide
an implementation for [`get_paginator()`](#django.views.generic.list.MultipleObjectMixin.get_paginator).

...
Functions are also [expressions](expressions.md), so they can be
used and combined with other expressions like [aggregate functions](querysets.md#aggregation-functions).

...
order of preference) the [`related_query_name`](fields.md#django.db.models.ForeignKey.related_query_name) set by the
user, the [`related_name`](fields.md#django.db.models.ForeignKey.related_name) set by the user, or the name
automatically generated by Django.

Hidden fields, fields with [`hidden=True`](fields.md#django.db.models.Field.hidden), cannot be retrieved by name.
...
: `False` by default. If set to `True`, `get_fields()` will include
  fields with [`hidden=True`](fields.md#django.db.models.Field.hidden).
...
When a [`CompositePrimaryKey`](fields.md#django.db.models.CompositePrimaryKey) is defined on a model
...
the model, either explicitly with [`primary_key=True`](fields.md#django.db.models.Field.primary_key) or implicitly as the [automatic
primary key](../../topics/db/models.md#automatic-primary-key-fields).

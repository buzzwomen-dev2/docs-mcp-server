...
If you [`pickle`](https://docs.python.org/3/library/pickle.html#module-pickle) a `QuerySet`, this will force all the results to be
...
statements), you can use [Q() objects](#q-objects) (`*args`).
...
If you need to execute more complex queries (for example, queries with `OR`
statements), you can use [`Q objects`](#django.db.models.Q) (`*args`).
...
expressions](expressions.md) or [Q() objects](#q-objects). Each object can be
annotated with:
...
For example, to use the [`FETCH_PEERS`](../../topics/db/fetch-modes.md#django.db.models.FETCH_PEERS) mode to
...
See more in the [fetch mode topic guide](../../topics/db/fetch-modes.md).
...
[fetch mode](../../topics/db/fetch-modes.md), at the cost of a more complex
initial query.
...
is defined. Instead of specifying the field name, use the [`related_name`](fields.md#django.db.models.ForeignKey.related_name) for the field on the related
object.
...
[fetch mode](../../topics/db/fetch-modes.md).
...
[`set()`](relations.md#django.db.models.fields.related.RelatedManager.set), on a
[`RelatedManager`](relations.md#django.db.models.fields.related.RelatedManager), any prefetched
...
[`managed`](options.md#django.db.models.Options.managed) documentation) containing just
...
using the same fields syntax as [`select_related()`](#django.db.models.query.QuerySet.select_related). Use the value
...
[`unique_together`](options.md#django.db.models.Options.unique_together)). If the fields used in
...
`get_or_create()` with `filter()` and using [Q() objects](#q-objects). For example,
...
[`ManyToManyField`](fields.md#django.db.models.ManyToManyField) attributes and reverse relations.
...
* The model’s `save()` method [will not be called](../../topics/db/models.md#methods-not-called-on-bulk-operations), and the `pre_save` and
  `post_save` signals will not be sent.
* It does not work with child models in a multi-table inheritance scenario.
* If the model’s primary key is an [`AutoField`](fields.md#django.db.models.AutoField) or has
  a [`db_default`](fields.md#django.db.models.Field.db_default) value, and `ignore_conflicts`
...
* Each model’s `save()` method [isn’t called](../../topics/db/models.md#methods-not-called-on-bulk-operations), and the
...
method [does not call](../../topics/db/models.md#methods-not-called-on-bulk-operations) any
...
[`on_delete`](fields.md#django.db.models.ForeignKey.on_delete) variants. Otherwise, for
database variants such as [`DB_CASCADE`](fields.md#django.db.models.DB_CASCADE), the return
...
The `delete()` method does a bulk delete and [does not call](../../topics/db/models.md#methods-not-called-on-bulk-operations) any `delete()` methods on your
models. It does, however, emit the [`pre_delete`](../signals.md#django.db.models.signals.pre_delete)
and [`post_delete`](../signals.md#django.db.models.signals.post_delete) signals for all deleted
...
[`on_delete`](fields.md#django.db.models.ForeignKey.on_delete) argument, e.g. `DB_CASCADE`.
...
[`Key and index lookups`](../../topics/db/queries.md#std-fieldlookup-jsonfield.key) are exceptions: they
...
An optional argument that represents the [model field](fields.md) of the return value

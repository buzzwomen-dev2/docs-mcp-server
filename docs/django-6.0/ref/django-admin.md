...
package containing your models. For example, if your [`INSTALLED_APPS`](settings.md#std-setting-INSTALLED_APPS)
...
settings module, either by setting the [`DJANGO_SETTINGS_MODULE`](../topics/settings.md#envvar-DJANGO_SETTINGS_MODULE)
...
[`managed`](models/options.md#django.db.models.Options.managed) option to `True` (or remove it
...
environment. Models from apps listed earlier in [`INSTALLED_APPS`](settings.md#std-setting-INSTALLED_APPS) take
...
See the guide on [customizing this behavior](../howto/custom-shell.md#customizing-shell-auto-imports) to add or remove automatic imports.
...
Disables the automatic import of models from [`INSTALLED_APPS`](settings.md#std-setting-INSTALLED_APPS).
...
information, please read [Squashing migrations](../topics/migrations.md#migration-squashing).
...
The template context (see [`Context`](templates/api.md#django.template.Context)) used for all
matching files is:
...
[`startapp --template`](#cmdoption-startapp-template) documentation for examples and usage. The same
...
The template context (see [`Context`](templates/api.md#django.template.Context)) used is:
...
* When you’re writing [unit tests](../topics/testing/overview.md) of how your
...
Please refer to its [`description`](contrib/staticfiles.md#django-admin-findstatic) in the
[staticfiles](contrib/staticfiles.md) documentation.
...
script, which lives in [extras/django_bash_completion](https://github.com/django/django/blob/main/extras/django_bash_completion) in the Django

...
As explained in [Outputting forms as HTML](api.md#ref-forms-api-outputting-html), the default label for a
...
See the [format localization documentation](../../topics/i18n/formatting.md) for
more information.
...
[`Form.bound_field_class`](api.md#django.forms.Form.bound_field_class).
...
[`ChoiceField`](#django.forms.ChoiceField).
...
Just like a [`MultipleChoiceField`](#django.forms.MultipleChoiceField), except
[`TypedMultipleChoiceField`](#django.forms.TypedMultipleChoiceField) takes two extra arguments, `coerce` and
`empty_value`.
...
formats for [`TimeField`](#django.forms.TimeField) are used.
...
Takes an instance of [`Form`](api.md#django.forms.Form) and the name of the field.
The returned [`BoundField`](api.md#django.forms.BoundField) instance will be used when accessing the
field in a template.

See [Customizing BoundField](api.md#custom-boundfield) for examples of overriding a `BoundField`.

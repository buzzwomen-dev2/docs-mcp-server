...
attributes in your [`Form`](#django.forms.Form) class. The values are the data you’re trying
to validate. These will usually be strings, but there’s no requirement that
they be strings; the type of data you pass depends on the [`Field`](fields.md#django.forms.Field), as
...
[`Form`](#django.forms.Form) instance, call the [`is_valid()`](#django.forms.Form.is_valid) method to run
...
note for each field in the [Built-in Field classes](fields.md#built-in-fields) section below.
...
Specifies the [renderer](renderers.md) to use for the form.
...
Specifies the [renderer](renderers.md) to use for
`ErrorList`. Defaults to `None` which means to use the default
renderer specified by the [`FORM_RENDERER`](../settings.md#std-setting-FORM_RENDERER) setting.
...
[`Field.bound_field_class`](fields.md#django.forms.Field.bound_field_class) to specify a different `BoundField` class
per form or per field, respectively.

See [Customizing BoundField](#custom-boundfield) for examples of overriding a `BoundField`.
...
[`Widget.attrs`](widgets.md#django.forms.Widget.attrs) to preserve the user defined attribute when rendering
the form.
...
The [`Form`](#django.forms.Form) instance this
[`BoundField`](#django.forms.BoundField) is bound to.
...
takes the form [`prefix`](#django.forms.Form.prefix) into account.
...
[`BaseRenderer.bound_field_class`](renderers.md#django.forms.renderers.BaseRenderer.bound_field_class) (along with a custom
[`FORM_RENDERER`](../settings.md#std-setting-FORM_RENDERER)), but can be overridden by the field-level
[`Field.bound_field_class`](fields.md#django.forms.Field.bound_field_class).

If not defined as a class variable, `bound_field_class` can be set via the
`bound_field_class` argument in the [`Form`](#django.forms.Form) or [`Field`](fields.md#django.forms.Field)
constructor.

For compatibility reasons, a custom form field can still override
[`Field.get_bound_field()`](fields.md#django.forms.Field.get_bound_field) to use a custom class, though any of the
...
[`Field`](fields.md#django.forms.Field) isn’t sufficient.
...
[`BaseRenderer.bound_field_class`](renderers.md#django.forms.renderers.BaseRenderer.bound_field_class) can be defined on a custom
[`FORM_RENDERER`](../settings.md#std-setting-FORM_RENDERER):

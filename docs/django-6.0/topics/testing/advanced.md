...
[`serialize_db_to_string()`](#django.db.connection.creation.serialize_db_to_string) but it was deprecated as it could result
...
[serialized_rollback=True](overview.md#test-case-serialized-rollback) enabled.
...
[routing configuration](../db/multi-db.md#topics-db-multi-db-routing).

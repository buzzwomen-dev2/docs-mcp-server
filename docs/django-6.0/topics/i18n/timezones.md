...
When time zone support is enabled ([`USE_TZ=True`](../../ref/settings.md#std-setting-USE_TZ)), Django
...
[`fromtimestamp()`](https://docs.python.org/3/library/datetime.html#datetime.datetime.fromtimestamp) and set the `tz` parameter to

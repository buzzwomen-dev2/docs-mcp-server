...
[`AUTHENTICATION_BACKENDS`](../../ref/settings.md#std-setting-AUTHENTICATION_BACKENDS), you’ll need to clear out session data
...
The Django admin is tightly coupled to the Django [User object](default.md#user-objects). For example, for a user to access the admin,
[`User.is_staff`](../../ref/contrib/auth.md#django.contrib.auth.models.User.is_staff) and [`User.is_active`](../../ref/contrib/auth.md#django.contrib.auth.models.User.is_active) must be `True` (see
[`AdminSite.has_permission()`](../../ref/contrib/admin/index.md#django.contrib.admin.AdminSite.has_permission) for details).
...
or [`User`](../../ref/contrib/auth.md#django.contrib.auth.models.User) otherwise.
...
custom model using the [`AUTH_USER_MODEL`](../../ref/settings.md#std-setting-AUTH_USER_MODEL) setting. For example:
...
differentiating [`User`](../../ref/contrib/auth.md#django.contrib.auth.models.User) and
[`AnonymousUser`](../../ref/contrib/auth.md#django.contrib.auth.models.AnonymousUser) objects. Generally, you should prefer
using [`is_authenticated`](../../ref/contrib/auth.md#django.contrib.auth.models.User.is_authenticated) to this attribute.
...
[`check_password()`](#django.contrib.auth.models.AbstractBaseUser.check_password) for
...
[`BaseUserManager`](#django.contrib.auth.models.BaseUserManager) providing two additional
methods:
...
[`User`](../../ref/contrib/auth.md#django.contrib.auth.models.User) model, but you want to add some
additional profile information, you could subclass
[`django.contrib.auth.models.AbstractUser`](#django.contrib.auth.models.AbstractUser) and add your custom profile
...
<a id="writing-authentication-backends-async-interface"></a>
...
[performance penalties](../async.md#async-performance).

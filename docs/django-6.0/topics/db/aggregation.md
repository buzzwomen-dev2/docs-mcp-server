...
The topic guide on [Django’s database-abstraction API](queries.md) described the way that you can use Django queries that
...
[API stability](../../misc/api-stability.md) policy).
...
<a id="aggregation-mysql-only-full-group-by"></a>
...
[`AnyValue`](../../ref/models/querysets.md#django.db.models.AnyValue) if the annotation includes a mix of
...
[`AnyValue`](../../ref/models/querysets.md#django.db.models.AnyValue).
...
#### Versionchanged
The [`AnyValue`](../../ref/models/querysets.md#django.db.models.AnyValue) aggregate was added.

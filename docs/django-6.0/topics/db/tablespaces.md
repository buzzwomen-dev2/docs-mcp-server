...
You can use the [`DEFAULT_TABLESPACE`](../../ref/settings.md#std-setting-DEFAULT_TABLESPACE) setting to specify a default
value for [`db_tablespace`](../../ref/models/options.md#django.db.models.Options.db_tablespace). This is useful for

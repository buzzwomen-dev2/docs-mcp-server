...
* Use [F() expressions](../../ref/models/expressions.md#f-expressions) to filter based on other fields within the same
  model.
...
Use the [`FETCH_PEERS`](fetch-modes.md#django.db.models.FETCH_PEERS) fetch mode to make on-demand
field access more efficient with bulk-fetching. Enable all it for all usage of
your models [with a custom manager](fetch-modes.md#fetch-modes-custom-manager).
...
[`prefetch_related()`](../../ref/models/querysets.md#django.db.models.query.QuerySet.prefetch_related), especially when it’s
hard to predict which fields will be accessed.

### Use `QuerySet.select_related()` and `prefetch_related()`

When the [`FETCH_PEERS`](fetch-modes.md#django.db.models.FETCH_PEERS) fetch mode is not appropriate or
efficient enough, use [`select_related()`](../../ref/models/querysets.md#django.db.models.query.QuerySet.select_related)
and [`prefetch_related()`](../../ref/models/querysets.md#django.db.models.query.QuerySet.prefetch_related). Understand their
documentation thoroughly and apply them where needed.

It may be useful to apply these methods in [managers and default managers](managers.md). Be aware when your manager is and is not used; for
example, related object access [uses the base manager](managers.md#managers-for-related-objects) rather than the default manager.

### Use `prefetch_related_objects()`

Where [`prefetch_related`](../../ref/models/querysets.md#django.db.models.query.QuerySet.prefetch_related) would be useful
after the queryset has been evaluated, use
[`prefetch_related_objects()`](../../ref/models/querysets.md#django.db.models.prefetch_related_objects) to execute an extra
prefetch.
...
Note that [`bulk_create()`](../../ref/models/querysets.md#django.db.models.query.QuerySet.bulk_create) has several
...
Note that [`bulk_update()`](../../ref/models/querysets.md#django.db.models.query.QuerySet.bulk_update) has several
caveats, so ensure it’s appropriate for your use case.
...
of the related models, use the [`delete()`](../../ref/models/querysets.md#django.db.models.query.QuerySet.delete)
method on a filtered queryset of the field’s
[`through`](../../ref/models/fields.md#django.db.models.ManyToManyField.through) model. By combining multiple
conditions with [Q() objects](../../ref/models/querysets.md#q-objects), you can delete several relationships in a

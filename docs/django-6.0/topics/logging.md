...
<a id="logging-security-implications"></a>
...
If the `disable_existing_loggers` key in the [`LOGGING`](../ref/settings.md#std-setting-LOGGING) dictConfig is
...
<a id="disabling-logging-configuration"></a>

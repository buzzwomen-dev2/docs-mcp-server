...
evaluation of a `QuerySet`. [QuerySets are lazy](db/queries.md#querysets-are-lazy).
...
warning in [`GZipMiddleware`](../ref/middleware.md#django.middleware.gzip.GZipMiddleware) for more
information.
...
[`ManifestStaticFilesStorage`](../ref/contrib/staticfiles.md#django.contrib.staticfiles.storage.ManifestStaticFilesStorage) appends
a content-dependent tag to the filenames of [static files](../ref/contrib/staticfiles.md) to make it safe for browsers to cache them
...
[this PyPy blog](https://pypy.org/posts/2023/01/string-concatenation-quadratic.html)).

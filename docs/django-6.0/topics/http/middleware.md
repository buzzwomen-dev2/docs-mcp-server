...
A Django installation doesn’t require any middleware — [`MIDDLEWARE`](../../ref/settings.md#std-setting-MIDDLEWARE)
...
`request` is an [`HttpRequest`](../../ref/request-response.md#django.http.HttpRequest) object. `response` is

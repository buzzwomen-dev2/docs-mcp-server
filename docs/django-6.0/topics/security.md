...
application. See the [forms documentation](forms/index.md) for
...
you have [enabled and used it](../howto/csrf.md#using-csrf) where appropriate. However, as
...
[limitations](../ref/csrf.md#csrf-limitations) if your site has subdomains that are
...
[`extra()`](../ref/models/querysets.md#django.db.models.query.QuerySet.extra) and
[`RawSQL`](../ref/models/expressions.md#django.db.models.expressions.RawSQL).
...
Django contains [clickjacking protection](../ref/clickjacking.md#clickjacking-prevention) in the
form of the [`X-Frame-Options middleware`](../ref/middleware.md#django.middleware.clickjacking.XFrameOptionsMiddleware) which in a supporting
...
* Use ‘secure’ cookies.
  ...
  [`CSRF_COOKIE_SECURE`](../ref/settings.md#std-setting-CSRF_COOKIE_SECURE) settings to `True`. This instructs the
...
* Use [HTTP Strict Transport Security](../ref/middleware.md#http-strict-transport-security) (HSTS)
  ...
  either be configured with [`SECURE_HSTS_SECONDS`](../ref/settings.md#std-setting-SECURE_HSTS_SECONDS),
  [`SECURE_HSTS_INCLUDE_SUBDOMAINS`](../ref/settings.md#std-setting-SECURE_HSTS_INCLUDE_SUBDOMAINS), and
  [`SECURE_HSTS_PRELOAD`](../ref/settings.md#std-setting-SECURE_HSTS_PRELOAD), or on the web server.
...
For configuration instructions, see the [Using CSP](../howto/csp.md#csp-config)
documentation, and refer to the [CSP overview](../ref/csp.md#csp-overview) for details
...
* Take a look at the Open Web Application Security Project (OWASP) [Top 10
  list](https://owasp.org/Top10/) which identifies some common vulnerabilities in web applications.

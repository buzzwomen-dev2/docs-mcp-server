...
to be a [`CompositePrimaryKey`](../ref/models/fields.md#django.db.models.CompositePrimaryKey):
...
You can assign a `tuple` to the [`pk`](../ref/models/instances.md#django.db.models.Model.pk) attribute.
...
[relational fields](#cpk-and-relations), including
[`GenericForeignKey`](../ref/contrib/contenttypes.md#django.contrib.contenttypes.fields.GenericForeignKey) fields, and the Django admin. Models with composite
...
Alternatively, [`SeparateDatabaseAndState`](../ref/migration-operations.md#django.db.migrations.operations.SeparateDatabaseAndState) may be used to execute the
backend-specific migrations and Django-generated migrations in a single
operation.

<a id="cpk-and-relations"></a>

## Composite primary keys and relations

[Relationship fields](../ref/models/fields.md#relationship-fields), including
[generic relations](../ref/contrib/contenttypes.md#generic-relations) do not support composite primary
keys.
...
[deprecation policy](../internals/release-process.md#internal-release-deprecation-policy).

<a id="cpk-and-database-functions"></a>
...
field [`FieldError`](../ref/exceptions.md#django.core.exceptions.FieldError).

## Composite primary keys in model validation

Since `pk` is only a virtual field, including `pk` as a field name in the
`exclude` argument of [`Model.clean_fields()`](../ref/models/instances.md#django.db.models.Model.clean_fields) has no effect. To exclude
the composite primary key fields from
[model validation](../ref/models/instances.md#validating-objects), specify each field individually.
[`Model.validate_unique()`](../ref/models/instances.md#django.db.models.Model.validate_unique) can still be called with `exclude={"pk"}` to
...
[`primary_key`](../ref/models/fields.md#django.db.models.Field.primary_key) attribute of its fields:
...
[`primary_key`](../ref/models/fields.md#django.db.models.Field.primary_key) attribute can no longer be relied
...
keys the [`_meta.pk_fields`](../ref/models/meta.md#django.db.models.options.Options.pk_fields)

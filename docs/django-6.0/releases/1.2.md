...
Forgery (CSRF) attacks](../ref/csrf.md). This type of attack occurs when a malicious
...
[`username`](../ref/contrib/auth.md#django.contrib.auth.models.User.username) field now allows a wider
...
Django’s [internationalization framework](../topics/i18n/index.md) has been
...
parsing data in forms. See [Format localization](../topics/i18n/formatting.md) for more details.
...
[release process](../internals/release-process.md).

...
* Fixed a regression in Django 5.2.2 where
  [`HttpRequest.get_preferred_type()`](../ref/request-response.md#django.http.HttpRequest.get_preferred_type)
  incorrectly preferred more specific media types with a lower quality
  ([#36447](https://code.djangoproject.com/ticket/36447)).
* Fixed a regression in Django 5.2.3 where `Value(None, JSONField())` used in
  a [`When`](../ref/models/conditional-expressions.md#django.db.models.expressions.When) condition was incorrectly

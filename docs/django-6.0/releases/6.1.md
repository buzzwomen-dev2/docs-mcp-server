...
These release notes cover the [new features](#whats-new-6-1), as well as
some [backwards incompatible changes](#backwards-incompatible-6-1) you’ll
want to be aware of when upgrading from Django 6.0 or earlier. We’ve
[begun the deprecation process for some features](#deprecated-features-6-1).
...
[fetch modes](../topics/db/fetch-modes.md). These modes allow you to control
...
2. `FETCH_PEERS` fetches a missing field for all instances that came from
   the same [`QuerySet`](../ref/models/querysets.md#django.db.models.query.QuerySet).
...
3. `RAISE` raises a [`FieldFetchBlocked`](../ref/exceptions.md#django.core.exceptions.FieldFetchBlocked)
   exception.

   This mode can prevent unintentional queries in performance-critical
   sections of code.

Use the new method [`QuerySet.fetch_mode()`](../ref/models/querysets.md#django.db.models.query.QuerySet.fetch_mode) to set the fetch mode for model
...
See [fetch modes](../topics/db/fetch-modes.md) for more details.

### Database-level delete options for `ForeignKey.on_delete`

[`ForeignKey.on_delete`](../ref/models/fields.md#django.db.models.ForeignKey.on_delete) now supports database-level delete options:

* [`DB_CASCADE`](../ref/models/fields.md#django.db.models.DB_CASCADE)
* [`DB_SET_NULL`](../ref/models/fields.md#django.db.models.DB_SET_NULL)
* [`DB_SET_DEFAULT`](../ref/models/fields.md#django.db.models.DB_SET_DEFAULT)
...
them. As a consequence, the [`DB_CASCADE`](../ref/models/fields.md#django.db.models.DB_CASCADE) option does
...
* The [`isempty`](../ref/contrib/gis/geoquerysets.md#std-fieldlookup-isempty) lookup and
...
* The new [`num_dimensions`](../ref/contrib/gis/geoquerysets.md#std-fieldlookup-num_dimensions) lookup and [`NumDimensions()`](../ref/contrib/gis/functions.md#django.contrib.gis.db.models.functions.NumDimensions) database function
...
* [`inspectdb`](../ref/django-admin.md#django-admin-inspectdb) now introspects
  [`HStoreField`](../ref/contrib/postgres/fields.md#django.contrib.postgres.fields.HStoreField) when `psycopg` 3.2+ is
  installed and `django.contrib.postgres` is in [`INSTALLED_APPS`](../ref/settings.md#std-setting-INSTALLED_APPS).
...
* Management commands now set [`ArgumentParser`](https://docs.python.org/3/library/argparse.html#argparse.ArgumentParser)'s
...
* [`QuerySet.in_bulk()`](../ref/models/querysets.md#django.db.models.query.QuerySet.in_bulk) now supports chaining after
  [`QuerySet.values()`](../ref/models/querysets.md#django.db.models.query.QuerySet.values) and [`QuerySet.values_list()`](../ref/models/querysets.md#django.db.models.query.QuerySet.values_list).
* The new [`JSONNull`](../ref/models/expressions.md#django.db.models.JSONNull) expression provides an explicit
  way to represent the JSON scalar `null`. It can be used when saving a
  top-level [`JSONField`](../ref/models/fields.md#django.db.models.JSONField) value, or querying for
  top-level or nested JSON `null` values. See
  [Storing and querying for None](../topics/db/queries.md#storing-and-querying-for-none) for usage examples and some caveats.
* [`DecimalField.max_digits`](../ref/models/fields.md#django.db.models.DecimalField.max_digits)
  and [`DecimalField.decimal_places`](../ref/models/fields.md#django.db.models.DecimalField.decimal_places) are no longer required to be
  set on Oracle, PostgreSQL, and SQLite.
* [`JSONField`](../ref/models/fields.md#django.db.models.JSONField) now supports
  [negative array indexing](../topics/db/queries.md#key-index-and-path-transforms) on Oracle
  21c+.
...
* Subclasses of models defining the `natural_key()` method can now opt out of
  ...
  [`dumpdata --natural-primary`](../ref/django-admin.md#cmdoption-dumpdata-natural-primary).
...
<a id="backwards-incompatible-6-1"></a>
...
* The `DatabaseIntrospection.get_relations()` should now return a dictionary
  ...
  delete options e.g. [`DB_CASCADE`](../ref/models/fields.md#django.db.models.DB_CASCADE).
...
* Top-level elements set to `None` in an
  [`ArrayField`](../ref/contrib/postgres/fields.md#django.contrib.postgres.fields.ArrayField) with a
  [`JSONField`](../ref/models/fields.md#django.db.models.JSONField) base field are now saved as SQL `NULL`
  instead of the JSON `null` primitive. This matches the behavior of a
  standalone [`JSONField`](../ref/models/fields.md#django.db.models.JSONField) when storing `None` values.

### System checks

* The [`check`](../ref/django-admin.md#django-admin-check) management command now supplies all `databases` if not
...
* [`GenericForeignKey`](../ref/contrib/contenttypes.md#django.contrib.contenttypes.fields.GenericForeignKey) now uses a
...
<a id="deprecated-features-6-1"></a>
...
* The use of `None` to represent a top-level JSON scalar `null` when
  querying [`JSONField`](../ref/models/fields.md#django.db.models.JSONField) is now deprecated in favor of
  the new [`JSONNull`](../ref/models/expressions.md#django.db.models.JSONNull) expression. At the end
  of the deprecation period, `None` values compile to SQL `IS NULL` when
  used as the top-level value. [`Key and index lookups`](../topics/db/queries.md#std-fieldlookup-jsonfield.key)
...
See [Features deprecated in 5.2](5.2.md#deprecated-features-5-2) for details on these changes, including how

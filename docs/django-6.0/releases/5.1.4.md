...
[`strip_tags()`](../ref/utils.md#django.utils.html.strip_tags) would be extremely slow to evaluate
...
before raising a [`SuspiciousOperation`](../ref/exceptions.md#django.core.exceptions.SuspiciousOperation) exception.
...
Applications that use the [`has_key`](../topics/db/queries.md#std-fieldlookup-jsonfield.has_key) lookup through

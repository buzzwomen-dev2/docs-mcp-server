...
* Fixed a regression in Django 5.1.5 that caused `validate_ipv6_address()`
  ...
  ([#36098](https://code.djangoproject.com/ticket/36098)).
* Fixed a regression in Django 5.1 where password fields, despite being set to
  ...
  [`BaseUserCreationForm`](../topics/auth/default.md#django.contrib.auth.forms.BaseUserCreationForm) ([#36140](https://code.djangoproject.com/ticket/36140)).

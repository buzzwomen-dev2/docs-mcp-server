...
[`doctest`](https://docs.python.org/3/library/doctest.html#module-doctest) or [`unittest`](https://docs.python.org/3/library/unittest.html#module-unittest) and test your views with a simple test
client.
...
See [the testing documentation](../topics/testing/index.md) for the full
details.

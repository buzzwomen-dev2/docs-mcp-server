...
#### SEE ALSO
The [1.0 release notes](1.0.md). That document explains the
...
declarations. You’ve already seen in [models]() above how to replace your
...
* The new admin comes with a ton of new features; you can read about them
  in the [admin documentation](../ref/contrib/admin/index.md).
...
The internal implementation of [`django.db.models.FileField`](../ref/models/fields.md#django.db.models.FileField) have
